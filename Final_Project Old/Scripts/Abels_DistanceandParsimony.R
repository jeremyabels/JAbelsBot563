...
setwd("C:/Users/jerem/OneDrive/Desktop/Phylo-Local/Final Project/")

##Import Data

dna <- fasta2DNAbin(file="SalmincolaCOIAligned.fasta")
...
image(x=1:21, y=1:21, temp, col=rev(heat.colors(100)), xaxt="n", yaxt="n",xlab="", ylab="")
axis(side=2, at=1:21, lab=rownames(dna), las=2, cex.axis=.5)
axis(side=3, at=1:21, lab=rownames(dna), las=3, cex.axis=.5)
